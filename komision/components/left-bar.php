    ...
    <div class="  komi-sidebar flex-column nav h-100   position-fixed">
        <div class=" mt-2">
            ...
            <div class='nav flex-column'>
                <a class='nav-link col-12 rounded-pill' href='/komision/?page=Home'>
                    <div class='nav-item'>
                        <i class='fa-solid fa-house svg'></i><span class='mx-3 d-none d-xl-inline-block'>Home</span>
                    </div>
                </a>
                <a class='nav-link col-12 rounded-pill' href='/komision/index.php?page=Listings'>
                    <div class='nav-item'>
            ...
            <a class='nav-link col-12 rounded-pill ' href='/komision/index.php?page=Messages'>
                                <div class='nav-item'>
            ...
            <div class='nav-item'>
                ...
                <a class="nav-link  col-12 rounded-pill justify-content-center align-items-center p-auto komit"
                   data-toggle='modal'
                   data-target='<?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
                       echo '#post-model';
                   } else {
                       echo '#login-model';
                   } ?>' href=''>
